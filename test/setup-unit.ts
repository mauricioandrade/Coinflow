...
process.env.JWT_SECRET = 'test_jwt_secret_for_unit_tests_only_64chars_long_padding_padding';
process.env.JWT_REFRESH_SECRET = 'test_refresh_secret_for_unit_tests_only_64chars_long_padding_xx';
